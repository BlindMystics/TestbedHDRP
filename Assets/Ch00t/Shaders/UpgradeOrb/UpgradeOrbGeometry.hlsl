...
[maxvertexcount(39)]
void UpgradeOrbGeometry(triangle v2g IN[3], uint pid : SV_PrimitiveID, inout TriangleStream<g2f> tristream)
{
	g2f o;
	...
	if (WithinEffectRegion(facePosition.y) && Random(pid) < _DripRatio) {
		...
		float cycleValue = Random(pid + effectRegionValue * 65535) + _Time.x * _DripSpeed;
